...
print_info(atoms)
kpts = get_kpts_from_kpd(atoms,kpd)
print('-----test 2 enforce_mean_plane_density-----')
kpts = get_kpts_from_kpd(atoms,kpd,enforce_mean_plane_density=True)
print('-----test 2 only_even-----')
kpts = get_kpts_from_kpd(atoms,kpd,only_even=True)
print()
...
print_info(atoms)
kpts = get_kpts_from_kpd(atoms,kpd)
print('-----test 3 only_even-----')
kpts = get_kpts_from_kpd(atoms,kpd,only_even=True)
print('-----test 3 only_even + enforce_mean_plane_density-----')
kpts = get_kpts_from_kpd(atoms,kpd,only_even=True, enforce_mean_plane_density=True)
print()
